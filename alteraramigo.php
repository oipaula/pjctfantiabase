...
<?php
    ...
    $nascimento = $_POST["cxnasc"];
    $alterar = "update tbamigos set amigo = '$nome', email = '$email', telefone = '$telefone', datanasc = '$nascimento' where codigo = '$cod';";
