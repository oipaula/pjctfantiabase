...
<body>
    ...
    <section class="forms-autentica">
        <form action="consultanomenucomercio.php" method="POST">
            <h1>Consulta - Comércio</h1> <br>
            Digite o comércio: <br>
            <input type="text" name="cxpesquisacomercio"/>
            <input type="submit" value="Buscar"/>
            <br>
            <a id="lista-completa" href="listarcomercio.php">Comércio</a>
        </form>
    </section>
