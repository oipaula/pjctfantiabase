...
<head>
    ...
    <style>
        .container {
                ...
                h2, h3 {
                    padding-top: 10px
                    margin: 0 0 20px 0; /* Adiciona margem inferior para espaçamento entre o título e o botão */
        }
    ...
    <nav>
        ...
        <?php
            if($_POST["cxcomercio"] != ""){
                ...
                $sql = "insert into tbcomercial(nome,comercio,email,telefone)
                values('$nome','$comercio','$email','$telefone')";
                $query = mysqli_query($conn,$sql);
                echo "<h3>Dados cadastrados com sucesso!</h3>";
            } else {
                echo "<h2>Dados não cadastrados!</h2>";
            }
        ?>
    </div>
