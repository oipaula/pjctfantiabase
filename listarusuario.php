...
<body>
    ...
    <?php
        ...
        $consultauser = "SELECT * FROM tbusuario;";
        $executar = mysqli_query($conn,$consultauser);
    ...
    <div id="cx1">
        ...
        <p>Usuário:</p><input type="text" name="cxnomeuser" value="<?php echo $linhauser['nome'];?>" readonly><br></br>
        <p>Senha:</p><input type="password" name="cxsenhauser" value="<?php echo $linhauser['senha']?>" readonly><br></br>
    </div>
        <?php
        };
        ?>
