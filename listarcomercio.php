...
<body>
    ...
    <div id="listar">
        ...
        $consulta = "select * from tbcomercial;";
    ...
    <p>Nome: </p><input type="text" name="cxnome" value="<?php echo $linha['nome'];?>" readonly><br></br>
    <p>Comércio:</p> <input type="text" name="cxcomercio" value="<?php echo $linha['comercio'];?>" readonly><br></br>
    <p>E-mail: </p><input type="text" name="cxemail" value="<?php echo $linha['email'];?>" readonly><br></br>
    <p>Telefone: </p><input type="text" name="cxtel" value="<?php echo $linha['telefone'];?>" readonly><br>
