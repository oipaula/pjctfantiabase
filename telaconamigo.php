...
<body>
    ...
    <section class="forms-autentica">
        <form action="consultanomenuamigo.php" method="POST">
            <h1>Consulta - Amigos</h1> <br>
            Digite o nome do amigo: <br>
            <input type="text" name="cxpesquisamigo"/>
            <input type="submit" value="Buscar"/>
            <br>
            <a id="lista-completa" href="listaramigo.php">Amigos</a>
        </form>
    </section>
